<div class="column col-sm-6">
    <!-- Category Name Field -->
    <div class="col-sm-12">
        {!! Form::label('category_name', __('models/pages.fields.category_name') . ':') !!}
    ...
    <!-- Created By Field -->
    <div class="col-sm-12">
        {!! Form::label('created_by', __('models/pages.fields.created_by') . ':') !!}
        <p>{{ $category->createdUser ? $category->createdUser->name : '' }}</p>
    </div>

    <!-- Updated By Field -->
    <div class="col-sm-12">
        {!! Form::label('updated_by', __('models/pages.fields.updated_by') . ':') !!}
