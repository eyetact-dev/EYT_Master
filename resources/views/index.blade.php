                ...
                <div class="page-header">
                    ...
                    <div class="page-rightheader">
                        <div class="btn btn-list">
                            <a href="{{ url('/' . ($page = '#')) }}" class="btn btn-info"><i class="fe fe-settings mr-1"></i>
                                General Settings </a>
                            <a href="{{ url('/' . ($page = '#')) }}" class="btn btn-danger"><i class="fe fe-printer mr-1"></i>
                                Print </a>
                            <a href="{{ url('/' . ($page = '#')) }}" class="btn btn-warning"><i
                                    ...
                                    <ul class="timeline mb-0">
                                        <li class="mt-0">
                                            ...
                                            <p class="text-muted fs-12"><span class="text-info">Joseph Ellison</span>
                                                finished task on<a href="{{ url('/' . ($page = '#')) }}"
                                        ...
                                        <li>
                                            ...
                                            <p class="text-muted fs-12"><span class="text-info">Elizabeth Scott</span>
                                                Product delivered<a href="{{ url('/' . ($page = '#')) }}"
                                        ...
                                        <li>
                                            ...
                                            <p class="text-muted fs-12"><span class="text-info">Sonia Peters</span>
                                                finished target on<a href="{{ url('/' . ($page = '#')) }}"
                                        ...
                                        <li>
                                            ...
                                            <p class="text-muted fs-12"><span class="text-info">Ella Lambert</span> ontime
                                                order delivery <a href="{{ url('/' . ($page = '#')) }}"
                                                    class="font-weight-semibold">Service Management</a></p>
                                        </li>
                                        <li>
                                            ...
                                            <p class="text-muted fs-12"><span class="text-info">Nicola Blake</span> visit
                                                the site<a href="{{ url('/' . ($page = '#')) }}"
                                                    class="font-weight-semibold"> Membership allocated</a></p>
                                        </li>
                                        <li>
                                            <div class="d-flex"><span class="time-data">Revenue Sources</span><span
                                                    class="ml-auto text-muted fs-11">15 May 2020</span></div>
                                            <p class="text-muted fs-12"><span class="text-info">Richard Mills</span>
                                                source report on<a href="{{ url('/' . ($page = '#')) }}"
                                                    class="font-weight-semibold"> Generated</a></p>
                                        </li>
                                        <li class="mb-0">
                                            <div class="d-flex"><span class="time-data">New Order Placed</span><span
                                                    class="ml-auto text-muted fs-11">11 May 2020</span></div>
                                            <p class="text-muted fs-12"><span class="text-info">Steven Hart</span> is
                                                proces the order<a href="{{ url('/' . ($page = '#')) }}"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-9 col-sm-9">
                                            <div class="media mt-0">
                                                <img src="{{ URL::asset('assets/images/users/1.jpg') }}" alt="img"
                                ...
                                <div class="list-card">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-9 col-sm-9">
                                            <div class="media mt-0">
                                                <img src="{{ URL::asset('assets/images/users/9.jpg') }}" alt="img"
                                                    class="avatar brround avatar-md mr-3">
                                                <div class="media-body">
                                                    <div class="d-md-flex align-items-center mt-1">
                                ...
                                <div class="list-card">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-9 col-sm-9">
                                            <div class="media mt-0">
                                                <img src="{{ URL::asset('assets/images/users/11.jpg') }}" alt="img"
                                                    class="avatar brround avatar-md mr-3">
                                                <div class="media-body">
                                                    <div class="d-md-flex align-items-center mt-1">
                                ...
                                <div class="list-card">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-9 col-sm-9">
                                            <div class="media mt-0">
                                                <img src="{{ URL::asset('assets/images/users/3.jpg') }}" alt="img"
                                                    class="avatar brround avatar-md mr-3">
                                                <div class="media-body">
                                                    <div class="d-md-flex align-items-center mt-1">
                                                        <h6 class="mb-1">Joseph Abraham</h6>
                            ...
                            <div class="card-body">
                                <div class="country-card">
                                    <div class="mb-5">
                                        <div class="d-flex">
                                            <span class=""><img
                                                    src="{{ URL::asset('assets/images/flags/us.svg') }}"
                                    ...
                                    <div class="mb-5">
                                        <div class="d-flex">
                                            <span class=""><img
                                                    src="{{ URL::asset('assets/images/flags/in.svg') }}"
                                    ...
                                    <div class="mb-5">
                                        <div class="d-flex">
                                            <span class=""><img
                                                    src="{{ URL::asset('assets/images/flags/ru.svg') }}"
                                    ...
                                    <div class="mb-5">
                                        <div class="d-flex">
                                            <span class=""><img
                                                    src="{{ URL::asset('assets/images/flags/ca.svg') }}"
                                    ...
                                    <div class="mb-5">
                                        <div class="d-flex">
                                            <span class=""><img
                                                    src="{{ URL::asset('assets/images/flags/ge.svg') }}"
                                    ...
                                    <div class="mb-5">
                                        <div class="d-flex">
                                            <span class=""><img
                                                    src="{{ URL::asset('assets/images/flags/br.svg') }}"
                                    ...
                                    <div class="mb-0">
                                        <div class="d-flex">
                                            <span class=""><img
                                                    src="{{ URL::asset('assets/images/flags/au.svg') }}"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                        src="{{ URL::asset('assets/images/orders/7.jpg') }}"
                                            ...
                                            <tr>
                                                <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                        src="{{ URL::asset('assets/images/orders/8.jpg') }}"
                                            ...
                                            <tr>
                                                <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                        src="{{ URL::asset('assets/images/orders/9.jpg') }}"
                                            ...
                                            <tr>
                                                <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                        src="{{ URL::asset('assets/images/orders/10.jpg') }}"
                                            ...
                                            <tr>
                                                <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                        src="{{ URL::asset('assets/images/orders/12.jpg') }}"
                                                        alt="media1"> Watch</td>
                                            ...
                                            <tr>
                                                <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                        src="{{ URL::asset('assets/images/orders/13.jpg') }}"
                                                        alt="media1"> Branded Shoes</td>
                                                <td><span class="badge badge-success">11</span></td>
                                                <td>04</td>
                                                <td>0</td>
                                                <td class="number-font">$ 3,256</td>
                                                <td><i class="fa fa-exclamation-triangle text-warning"></i> Out of stock
                                                </td>
                                            </tr>
                                            <tr class="mb-0">
                                                <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                        src="{{ URL::asset('assets/images/orders/11.jpg') }}"
                                                        alt="media1"> New EarPhones</td>
                                                <td><span class="badge badge-warning">60</span></td>
                                                <td>10</td>
                                                <td>0</td>
                                                <td class="number-font">$ 7,652</td>
                                                <td><i class="fa fa-exclamation-triangle text-danger"></i> Out of stock
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
