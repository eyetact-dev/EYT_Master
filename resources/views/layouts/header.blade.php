              ...
              <div class="d-flex">
                  <a class="header-brand" href="{{ url('/' . ($page = 'index')) }}">
                      ...
                      <img src="{{ URL::asset('assets/images/brand/logo1.png') }}" class="header-brand-img dark-logo"
                          alt="Admintro logo">
                      <img src="{{ URL::asset('assets/images/brand/favicon.png') }}"
                  ...
                  <div class="d-flex order-lg-2 ml-auto">
                      <a href="{{ url('/' . ($page = '#')) }}" data-toggle="search"
                      ...
                      {{--                                        <div class="dropdown" style="padding-top: 15px; padding-right: 11px;"> --}}
                      {{--                                            <label class="custom-switch"> --}}
                      {{--                                                <span class="custom-switch-description mr-2">Dark Mode</span> --}}
                      {{--                                                <input type="checkbox" name="custom-switch-checkbox" id="ModeChangeDropdown" class="custom-switch-input"> --}}
                      ...
                      <div class="dropdown profile-dropdown">
                          <a href="{{ url('/' . ($page = '#')) }}" class="nav-link pr-0 leading-none"
                              ...
                              <span>
                                  <img src="{{ Auth::user()->profile_url }}" alt="img"
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                              ...
                              <a class="dropdown-item d-flex" href="{{ url('/profile' . ($page = '#')) }}">
                              ...
                              <a class="dropdown-item d-flex" href="{{ route('all_mails') }}">
                                  <i class="fe fe-inbox fs-18 header-icon mr-3"></i>
                                  <div class="">My Inbox</div>
                              </a>
