        ...
        <div class="card">
            <div class="card-head">
                <div class="card-header">
                    <h4 class="inline">@lang('models/store_view.create')</h4>
                    <div class="heading-elements mt-0">

                    </div>
                </div>
            </div>
            {!! Form::open(['route' => 'store_view.store', 'files' => true, 'id' => 'categoryForm']) !!}

            <div class="card-body">
                <div class="row">
                    @include('store_view.fields', ['pageType' => 'Add'])
                </div>
            </div>

            <div class="card-footer">
                {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
                <a href="{{ route('store_view.index') }}" class="btn btn-default">
                    @lang('crud.cancel')
                </a>
            </div>
