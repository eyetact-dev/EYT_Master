<script>
    function checkMinAndMaxLength(index) {
        let columType = $(`.form-column-types`).val()
    ...
    function removeInputTypeHidden(index) {
        $(`.form-file-types`).remove()
        $(`.form-file-sizes`).remove()
        $(`.form-mimes`).remove()
        $(`.form-step`).remove()
    }
    ...
    function setInputTypeDefaultValue(index) {
        let checkColumnType = $(`.form-column-types`).val()
        let checkInputType = $(`.form-input-types`).val()
