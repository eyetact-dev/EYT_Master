                ...
                <div class="box-widget widget-user">
                    <div class="widget-user-image1 d-sm-flex">
                        <div class="img-container">
                            <img alt="File Image" class="rounded-circle profile-img border p-2"
                                src="{{ asset($file->image) }}">


                        </div>
                        <div class="mt-1 ml-lg-5">
                            <h4 class="pro-user-username mb-3 font-weight-bold">{{ $file->name }} </h4>
                            <ul class="mb-0 pro-details">
                                <p class="mb-3"><strong>Name : </strong> {{ $file->name }}</p>
            ...
            <div class="border-0">
                <div class="tab-content">
                    <div class="tab-pane active" id="myProfile">
                        <div class="card">
                            <form action="{{ route('file.update', $file->id) }}" method="POST" id="editProfile"
