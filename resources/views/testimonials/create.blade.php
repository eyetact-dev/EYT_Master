        ...
        <div class="card">
            <div class="card-head">
                <div class="card-header">
                    <h4 class="inline">@lang('models/testimonials.create')</h4>
            ...
            {!! Form::open(['route' => 'testimonials.store', 'files' => true, 'id' => 'categoryForm']) !!}

            <div class="card-body">
                <div class="row">
                    @include('testimonials.fields', ['pageType' => 'Add'])
                </div>
            </div>
